    ...
    const burgerTypes = [
        {
            ...
            price: ['$12'],
            imageSrc: 'https://github.com/cbd23/restaurant-page/blob/main/src/hamburger-types/hamburger1.jpeg',
        },

        {
            ...
            price: ['$15'],
            imageSrc: 'https://github.com/cbd23/restaurant-page/blob/main/src/hamburger-types/hamburger2.jpeg',
        },

        {
            ...
            price: ['$14'],
            imageSrc: 'https://github.com/cbd23/restaurant-page/blob/main/src/hamburger-types/hamburger3.jpeg',
        },

        {
            ...
            price: ['$17'],
            imageSrc: 'https://github.com/cbd23/restaurant-page/blob/main/src/hamburger-types/hamburger4.jpeg',
        },
    ];
